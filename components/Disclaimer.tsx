...
export default function Disclaimer() {
  return (
    <p className="mt-10 border-t border-slate-200 pt-4 text-sm leading-relaxed text-slate-500 dark:border-slate-800 dark:text-slate-400">
      本站為非官方的第三方整理，與節目及其製作方沒有任何關係。內容由程式從公開音檔自動轉寫與抽取，
