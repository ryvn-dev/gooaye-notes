...
export default function TimecodeButton({ seconds, label }: { seconds: number; label?: string }) {
  return (
    <button
      ...
      className="inline-flex h-[1.9em] w-5 shrink-0 items-center justify-center self-start align-middle leading-none text-[#9a9a9a] transition-colors hover:text-[#242424]"
    >
